Config = {
	...
	img = "core_inventory/html/img/", -- Set this to your inventory
	LeukMenu = true, -- Enable this if you are using an updated qb-menu resource with icon support
	...
	Products = {
		...
		["hardware"] = {
			{ name = "small_backpack", price = 210, amount = 100, },
			{ name = "medium_bag", price = 522, amount = 100, },
		...
		["policearmory"] = {
			{ name = "weapon_stungun", price = 0, amount = 250, info = {}, requiredJob = { ["police"] = 0 }  },
			{ name = "weapon_pistol", price = 247, amount = 250, info = {}, requiredJob = { ["police"] = 0 } },
			{ name = "weapon_combatpdw", price = 678, amount = 5, info = nil, requiresLicense = false, requiredJob = { ["police"] = 0 } },
			{ name = "weapon_specialcarbine_mk2", price = 1243, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "weapon_nightstick", price = 102, amount = 5, info = nil, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "pistol_ammo", price = 20, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "smg_ammo", price = 34, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "shotgun_ammo", price = 53, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "rifle_ammo", price = 87, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "handcuffs", price = 0, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "weapon_flashlight", price = 0, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "empty_evidence_bag", price = 0, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "police_stormram", price = 250, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
			{ name = "armor", price = 17, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0  } },
			{ name = "radio", price = 0, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0  } },
			{ name = "heavyarmor", price = 102, amount = 250, info = {}, requiresLicense = false, requiredJob = { ["police"] = 0, ["none"] = 0 } },
		},
		["hunting"] = {
			{ name = "weapon_sniperrifle", price = 687, amount = 50, },
			{ name = "snp_ammo", price = 15, amount = 50, },
			{ name = "weapon_knife", price = 20, amount = 50, },
...
Config.Locations = {
    ...
    ["hardware"] = {
		...
		["coords"] = {
			vector4(2738.4441, 3461.5986, 55.6956, 347.3203),
		},
	...
	["police"] = { -- More of a test/example - Gang accessible stores
		["label"] = "Police armory",
		["color"] = "#226b80",
		["type"] = "items",
		["job"] = "police",
		["logo"] = "https://static.wikia.nocookie.net/alterlifepolicedepartement/images/5/51/R_%281%29.png",
		["model"] = {
			`s_f_y_cop_01`,
			`s_m_y_cop_01`,
		},
		["coords"] = {
			vector4(480.3002, -995.2990, 30.6898, 231.6217),
		},
		["products"] = Config.Products["policearmory"], -- example using coffeplace info
		["hideblip"] = true,
	},
}
